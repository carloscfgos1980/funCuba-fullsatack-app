const pagesContent = {
  airSlogan: "We have carefully selected best Airbnb deals for you!",
  ...
  chillingSlogan: "Do you wanna know why we Cubans always looks happy? Take a deep dive in the chilling activities!",
  chillingI:
